...
class Scene4 extends Scene {
    fun @construct() {
        ...
        [
            new Note("1.5|o0|a0.70", "s", 25::ms, 25::ms),
            new Note("1.5|o0|a0.55", "s", 25::ms, 25::ms),
            new Note("1.5|o0|a0.65", "s", 25::ms, 25::ms),
            new Note("1.5|o0|a0.45", "s", 25::ms, 25::ms),
        ] @=> Note seq2B[];
        ...
        [
            new Note("1.0|o0|a0.70", "s", 25::ms, 25::ms),
            new Note("1.0|o0|a0.55", "s", 25::ms, 25::ms),
            new Note("1.0|o0|a0.65", "s", 25::ms, 25::ms),
            new Note("1.0|o0|a0.45", "s", 25::ms, 25::ms),
        ] @=> Note seq2D[];

        [
            new Note("0.73|o0|a0.70", "s", 25::ms, 25::ms),
            new Note("0.73|o0|a0.55", "s", 25::ms, 25::ms),
            new Note("0.73|o0|a0.65", "s", 25::ms, 25::ms),
            new Note("0.73|o0|a0.45", "s", 25::ms, 25::ms),
        ] @=> Note seq2E[];
