...
class Scene4 extends Scene {
    fun @construct() {
        ...
        [
            new Note("1|o1|a0.08", "s", 10::ms, 0::ms),
            new Note("2|o1|a0.12", "s", 0::ms, 0::ms),
            new Note("3|o1|a0.14", "s", 0::ms, 0::ms),
            new Note("0|o2|a0.18", "s", 0::ms, 0::ms),

            new Note("1|o2|a0.23", "s", 0::ms, 0::ms),
            new Note("0|o2|a0.29", "s", 0::ms, 0::ms),
            new Note("3|o1|a0.33", "s", 0::ms, 0::ms),
            new Note("2|o1|a0.39", "s", 0::ms, 10::ms),
        ] @=> Note seq2A[];

        [
            new Note("1|o2|a0.33", "w", 1500::ms, 0::ms),
            new Note("1|o2|a0.33", "h.", 0::ms, 0::ms),
            new Note("1|o2|a0.33|r0.1", "e", 0::ms, 250::ms),
            new Note("1|o2|a0.10|r0.02", "s", 0::ms, 125::ms),
            new Note("1|o2|a0.02", "s", 0::ms, 125::ms),
        ] @=> Note seq2B[];

        [
            new Note("3|o0|a0.32", "w", 1500::ms, 0::ms),
            new Note("3|o0|a0.52", "w", 1500::ms, 5::ms),
        ] @=> Note seq3A[];
...
class Scene11 extends Scene {
    fun @construct() {
        ...
        [
            ...
            new Note("0|o-1|a0.6", "e", 150::ms, 0::ms),
            new Note("0|o-1|a0.6", "e", 0::ms, 0::ms),
            new Note("0|o-1|a0.6", "e", 0::ms, 0::ms),
            new Note("0|o-1|a0.6", "e", 0::ms, 0::ms),
            new Note("0|o-1|a0.6|r0.1", "h.", 500::ms, 700::ms),
            new Note("0|o-1|a0.1|r0.03", "q.", 0::ms, 400::ms),
            new Note("0|o-1|a0.03", "e", 0::ms, 200::ms),
        ] @=> Note seq4A[];
